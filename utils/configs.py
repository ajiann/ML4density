...
class Parser(object):
    def __init__(self) -> None:
        ...
        self.parser.add_argument('--task', default='NNfordensity')

        self.parser.add_argument('--save_path', default='work_dir/NNfordensity/')
        ...
        self.parser.add_argument('--eval-metric', default=['SSIM'])
        # self.get_remainder()
        
    def get_remainder(self):
        if self.parser.parse_args().task == 'NNfordensity':
